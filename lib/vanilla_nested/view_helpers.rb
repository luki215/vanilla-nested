...
module VanillaNested
  module ViewHelpers
    ...
    # @param new_instance [Object instance] Instance that is used as base for the form
    ...
    def link_to_add_nested(form, association, container_selector, link_text: nil, link_classes: '', insert_method: :append, partial: nil, partial_form_variable: :form, partial_locals: {}, tag: 'a', tag_attributes: {}, new_instance: nil, &link_content)
      association_class = form.object.class.reflections[association.to_s].klass
      object = new_instance || association_class.new
      ...
      content_tag('template', id: template_id) do 
        html 
      end
    end
